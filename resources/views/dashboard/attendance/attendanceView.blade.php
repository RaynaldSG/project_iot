...
@section('content')
    ...
    <div class="row justify-content-center align-items-center" style="height: 100%">
        <div class="col-lg-8">
            ...
            <table class="table table-striped text-center mt-5 table-responsive-lg">
                <thead>
                  <tr>
                    <th scope="col">No</th>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ ($Carbon::parse($log->in)->subMinutes(30)->format("His") <= $Carbon::parse($log->user->shift->start)->format("His")) ? 'Tepat Waktu' : 'Terlambat' }}</td>
                    </tr>
                    @endforeach
                </tbody>
              </table>
