<div class="offcanvas offcanvas-start" tabindex="-1" id="sidebar" aria-labelledby="offcanvasExampleLabel" style="background-image: linear-gradient(180deg, #e0c3fc 0%, #8ec5fc 100%)">
    ...
    <div class="offcanvas-body">
        <div class="container mb-2">
            <a class="text-decoration-none text-black icon-link icon-link-hover" style="font-size: 20px; --bs-icon-link-transform: translate3d(0, -0.25rem, 0);" href="/dashboard"><i class="bi bi-house-door-fill"></i>Dashboard</a>
        </div>
        <div class="container mb-2">
        ...
        <div class="container mb-2">
            <a class="text-decoration-none text-black icon-link icon-link-hover" style="font-size: 20px; --bs-icon-link-transform: translate3d(0, -0.25rem, 0);" href=""><i class="bi bi-card-checklist me-2"></i>Attendance</a>
        </div>
        <hr>
        <div class="container mb-2">
